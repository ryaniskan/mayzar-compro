...
$page_title = __('Edit Privacy Policy');
$page_data = db_get_by_slug('pages', 'privacy');
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0"><?php echo __('Edit Privacy Policy'); ?></h1>
                        </div>
                ...
                <div class="container-fluid">
                    ...
                    <form id="pageForm" action="pages_handler" method="POST" onsubmit="wysiwygSyncAll()">
                        ...
                        <div class="card card-info card-outline">
                            <div class="card-header">
                                <h3 class="card-title"><?php echo __('Policy Content'); ?></h3>
                            </div>
                            <div class="card-body">
                                <?php render_wysiwyg([
                                    'id' => 'pageContent',
