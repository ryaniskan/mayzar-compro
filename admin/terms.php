...
$current_page = 'terms';
$page_title = __('Edit Terms of Service');
$page_data = db_get_by_slug('pages', 'terms');
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0"><?php echo __('Edit Terms of Service'); ?></h1>
                        </div>
                ...
                <div class="container-fluid">
                    ...
                    <form id="pageForm" action="pages_handler" method="POST" onsubmit="wysiwygSyncAll()">
                        ...
                        <div class="card card-info card-outline">
                            <div class="card-header">
                                <h3 class="card-title"><?php echo __('Terms Content'); ?></h3>
                            </div>
                            <div class="card-body">
                                <?php render_wysiwyg([
                                    'id' => 'pageContent',
